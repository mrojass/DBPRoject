...
<html style="background-color:#003366">
	...
	<body>
		...
		<p>Request Deploy:</p>
		<form>
		<label>Deploy To AgencyID:</label><input type="integer" name="TAid" value=""></input><br>
		<label>Deploy From AgencyID:</label><input type="integer" name="FAid" value=""></input><br>
		<label>EquipmentID:</label><input type="integer" name="Eid"></input><br>
		<p>Approve Deploy:</p>
